          ...
          index !== mainImage && (
            ...
            >
              <img
                ...
                className="w-full h-full object-cover cursor-pointer border hover:border-black transition-all duration-200 hover:opacity-80"
              />
            </div>
          )
        ))}
...
const MorePhotosButton = ({ selectedType, setShowAllPhotos }) => (
  ...
  >
    ...
    />
    <div className="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-50 flex items-center justify-center transition-all duration-200">
